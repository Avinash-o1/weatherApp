import CalloutCard from "@/Componets/CalloutCard";
import HumidityChart from "@/Componets/HunidityChart";
import InformationPanel from "@/Componets/InformationPanel";
import RainChart from "@/Componets/RainChart";
import StatCard from "@/Componets/StatCard";
import TempChart from "@/Componets/TempChart";
        ...
        <div className="p-5">
          <div className="pb-5">
            ...
            <p className="text-sm text-gray-400">
              Last updated at:{" "}
              {new Date(results.current_weather.time).toLocaleString()} Timezone
              location- {results.timezone}
            </p>
          </div>
